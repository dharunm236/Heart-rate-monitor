...
void ssd1306_TestFonts1() {
    ...
    ssd1306_SetCursor(2, y);
    ssd1306_WriteString("93 BPM", Font_16x26, White);
    y += 26;
    #endif
...
void ssd1306_test(double *value) {
	...
	#ifdef SSD1306_INCLUDE_FONT_11x18
    ssd1306_SetCursor(2, y);
    ssd1306_WriteString("Temp is", Font_11x18, White);
    y += 18;
    #endif
...
void ssd1306_TestFPS() {
    ...
    uint32_t end = start;
    int fps = 0;
    char message[] = "Embedded Project";
   
    ssd1306_SetCursor(2,0);
    ssd1306_WriteString("Group 9", Font_11x18, Black);
    ssd1306_SetCursor(2, 18*2);
    ssd1306_WriteString("HeartRate Monitor", Font_11x18, Black);
